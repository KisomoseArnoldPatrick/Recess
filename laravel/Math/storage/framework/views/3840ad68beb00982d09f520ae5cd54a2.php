...
<html lang="en">
   <head>
      ...
      <!-- Favicon -->
      <link rel="icon" href="<?php echo e(asset('assets2/images/favicon.png')); ?>" type="image/x-icon" />
      <!-- Bootstrap CSS -->
      <link href="<?php echo e(asset('assets2/css/bootstrap.min.css')); ?>" rel="stylesheet">
      <!-- Animate CSS -->
      <link href="<?php echo e(asset('assets2/vendors/animate/animate.css')); ?>" rel="stylesheet">
      <!-- Icon CSS-->
      <link rel="stylesheet" href="<?php echo e(asset('assets2/vendors/font-awesome/css/font-awesome.min.css')); ?>">
      <!-- Camera Slider -->
      <link rel="stylesheet" href="<?php echo e(asset('assets2/vendors/camera-slider/camera.css')); ?>">
      <!-- Owlcarousel CSS-->
      <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets2/vendors/owl_carousel/owl.carousel.css')); ?>" media="all">
      <!--Template Styles CSS-->
      <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets2/css/style.css')); ?>" media="all" />
   ...
   <body id="top">
            ...
            <div class="overlay-all ">
               ...
               <header class="s-header">
                  ...
                  <nav class="header-nav">
                    ...
                    <li><a href="<?php echo e(url('/dashboard')); ?>" class="">Dashboard</a></li>
                    <?php else: ?>
                    <li><a href="<?php echo e(route('login')); ?>" class="">Log in</a></li>
                   <?php if(Route::has('register')): ?>
                   <li><a href="<?php echo e(route('register')); ?>" class="">Register</a></li>
                        <?php endif; ?>
                    <?php endif; ?>
                    <?php endif; ?>
                        </ul>
      ...
      <!-- Animate JS -->
      <script src="<?php echo e(asset('assets2/vendors/animate/wow.min.js')); ?>"></script>
      <script src="<?php echo e(asset('assets2/vendors/sidebar/main.js')); ?>"></script>
      <!-- Owlcarousel JS -->
      <script src="<?php echo e(asset('assets2/vendors/owl_carousel/owl.carousel.min.js')); ?>"></script>
      <!-- Stellar JS-->
      <!-- Theme JS -->
      <script src="<?php echo e(asset('assets2/js/theme.min.js')); ?>"></script>
   </body>
</html>
...
<?php /**PATH C:\Users\USER\Desktop\Recess\laravel\Math\resources\views/welcome.blade.php ENDPATH**/ ?>