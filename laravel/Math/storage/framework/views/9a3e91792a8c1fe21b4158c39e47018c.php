...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/libs/@fullcalendar/core/main.min.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(asset('assets/libs/@fullcalendar/daygrid/main.min.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(asset('assets/libs/@fullcalendar/bootstrap/main.min.css')); ?>" type="text/css">
        <link rel="stylesheet" href="<?php echo e(asset('assets/libs/@fullcalendar/timegrid/main.min.css')); ?>" type="text/css">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item text-danger" href="<?php echo e(route('logot')); ?> "><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</a>
                            </div>
                        </div>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo e(route('schoolform')); ?>">Register</a></li>
                                    <li><a href="<?php echo e(route('schools.index')); ?>">All Schools</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li>
                                        ...
                                        <li><a href="<?php echo e(route('pupils.index')); ?>">Pupils Registered</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="<?php echo e(route('challengeform')); ?>">Create Challenges</a></li>
                                    <li><a href="<?php echo e(route('challenges.index')); ?>">View Challenges</a></li>
                                </ul>
                            </li>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © GROUP G-33
                            </div>
                            <div class="col-sm-6">
...
<script src="<?php echo e(asset('assets/js/pages/form-wizard.init.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('assets/libs/jquery-ui-dist/jquery-ui.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/libs/@fullcalendar/core/main.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/libs/@fullcalendar/bootstrap/main.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/libs/@fullcalendar/daygrid/main.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/libs/@fullcalendar/timegrid/main.min.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/libs/@fullcalendar/interaction/main.min.js')); ?>"></script>
         <!-- Calendar init -->
         <script src="<?php echo e(asset('assets/js/pages/calendar.init.js')); ?>"></script>
       

       
    </body>

</html><?php /**PATH C:\Users\USER\Desktop\Recess\laravel\Math\resources\views/layouts/dash.blade.php ENDPATH**/ ?>