                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="<?php echo e(route('subbs')); ?>" >
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.dash", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\Recess\laravel\Math\resources\views/schoolreg.blade.php ENDPATH**/ ?>